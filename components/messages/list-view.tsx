                ...
                {channels.length > 0 && (
                    <>
                        ...
                        {channels.map((channel) => (
                            ...
                            >
                                <div className="h-14 w-14 rounded-2xl bg-muted/60 flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-105 group-hover:bg-primary/5">
                    ...
                    >
                        <div className="relative flex-shrink-0 transition-transform group-hover:scale-105">
                            <Avatar className="h-14 w-14 shadow-sm">
                                ...
                                <AvatarFallback className="bg-muted text-muted-foreground text-lg">
                                    {getInitials(conv.user.full_name, conv.user.email)}
                                </AvatarFallback>
                            </Avatar>
                        ...
                        <div className="flex-1 min-w-0 text-left">
                            <div className="flex items-center justify-between gap-2 mb-0.5">
                                ...
                                <span className="text-[11px] font-bold text-muted-foreground/60 flex-shrink-0 uppercase">
                                    {formatTime(
                            ...
                            <div className="flex items-center justify-between gap-2">
                                ...
                                {conv.unread > 0 && (
                                    <Badge className="h-5 min-w-5 justify-center rounded-full flex-shrink-0 border-none bg-primary font-bold text-[10px]">
                                        {conv.unread}
                                    </Badge>
                                )}
                            </div>
