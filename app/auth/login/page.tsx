...
import { loginAction, oauthLoginAction } from "@/app/auth/actions";
...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Success is handled by the redirect inside loginAction
    } catch (err: any) {
      ...
      setError("An error occurred while connecting to the server. Please check your internet connection.");
      setLoading(false);
    }
  };
  ...
  const handleSocialLogin = async (provider: Provider) => {
    ...
    try {
      ...
      // If success, server action will redirect to provider
    } catch (err: any) {
